...
#data path = notbook/data/income_cleandata.csv
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            logging.info("data reading using pandas libraiy from local system")
            ...
            logging.info("Error occure in data ingestion stage")
