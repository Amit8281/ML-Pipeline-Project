...
# convert catagorical into numerical
...
class DataTransformation:
    ...
    def remove_outliers_IQR(self,col,df):
        try:
            logging.info("handling outliers started")
            ...
            logging.info("outliers handling done")
            raise CustomException(e,sys)
    ...
    def initiate_data_transformation(self,train_path, test_path):
        ...
        try:
            ...
            logging.info("outliers caped on train data")

            for col in numerical_features:
                self.remove_outliers_IQR(col = col,df=test_data)

            logging.info("outliers caped on test data")
            ...
            #apply transformation train data and test data
            ...
            #preprocessor object on our train and test data
